...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.taskTabWidget.setObjectName(u"taskTabWidget")
        ...
        self.timeTabWidget.setObjectName(u"timeTabWidget")
        ...
        self.time_sum_label.setObjectName(u"time_sum_label")
        font1 = QFont()
        ...
        self.time_sum_today_label.setObjectName(u"time_sum_today_label")
        ...
        self.time_sum_week_label.setObjectName(u"time_sum_week_label")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.time_sum_label.setText(QCoreApplication.translate("Dialog", u"You have logged in", None))
        self.time_sum_today_label.setText(QCoreApplication.translate("Dialog", u"0 hour today", None))
        self.time_sum_week_label.setText(QCoreApplication.translate("Dialog", u"0 hour this week", None))
    # retranslateUi
